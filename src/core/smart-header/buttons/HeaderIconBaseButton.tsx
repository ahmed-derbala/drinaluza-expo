...
export function HeaderIconBaseButton({ icon, iconType = 'ionicons', label, onPress, disabled, loading, iconColor, badgeCount = 0, size = 38, style }: HeaderIconBaseButtonProps) {
