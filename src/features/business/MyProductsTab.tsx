...
export default function MyProductsTab() {
	...
	return (
		<View style={[styles.container, { backgroundColor: colors.background }]}>
				...
				ListEmptyComponent={
					<View style={styles.emptyContainer}>
						...
						<TouchableOpacity
							...
							onPress={() => router.push({ pathname: '/business/create-product', params: { source: 'my-products' } } as never)}
						>
			...
			<TouchableOpacity style={styles.fabContainer} onPress={() => router.push({ pathname: '/business/create-product', params: { source: 'my-products' } } as never)}>
